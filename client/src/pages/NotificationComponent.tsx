  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      type: "health",
      title: "Comming Soon: Health Check Reminder",
      message:
        "Stay tuned for our upcoming health check reminder feature, designed to help you maintain your health metrics effectively.",
      time: "2 hours ago",
      read: false,
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-4 flex-1">
                      {/* Icon */}
                      <div
                        className={`p-3 rounded-xl ${notification.bgColor} ${notification.color} flex-shrink-0`}>
                        {notification.icon}
                      </div>
