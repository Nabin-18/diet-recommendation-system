  ...
  useEffect(() => {
    if (dashboardData?.inputDetails) {
      ...
      if (!hasSubmitted) {
        ...
        if (allowedGenders.includes(details.gender as typeof allowedGenders[number])) {
          setValue("gender", details.gender as typeof allowedGenders[number]);
        } else {
          setValue("gender", "male");
        }
        // Ensure goal is one of the allowed values
        const allowedGoals = ["weight_gain", "weight_loss", "maintain"] as const;
        if (allowedGoals.includes(details.goal as typeof allowedGoals[number])) {
        ...
        if (allowedActivities.includes(details.activity as typeof allowedActivities[number])) {
          setValue("activityType", details.activity as typeof allowedActivities[number]);
        } else {
          setValue("activityType", "walking");
        }
        setValue(
          "preferences",
          details.preference === "vegetarian" || details.preference === "non-vegetarian"
            ? details.preference
            : "vegetarian"
        );
 ...
 const onSubmit = async (inputData: DietFormInputData) => {
  ...
  try {
    ...
    if (!recommendationsResponse.data.predictions) {
      console.error("Server response missing predictions:", recommendationsResponse.data);
          ...
          <div className="flex flex-col gap-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Fill in your details to receive customized nutrition recommendations
              </p>
            </div>
            ...
            <h2 className="font-bold text-xl text-gray-800 mt-4">Health & Fitness Preferences</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                />
                {errors.healthIssues && (
                  <p className="text-red-500 text-sm mt-1">{errors.healthIssues.message}</p>
                )}
              </div>
            </div>

            <h2 className="font-bold text-xl text-gray-800 mt-4">Meal Planning</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="general">General (All Meals)</SelectItem>
              ...
              <div>
                ...
                {errors.mealFrequency && (
                  <p className="text-red-500 text-sm mt-1">{errors.mealFrequency.message}</p>
                )}
              </div>
            </div>
        ...
        <div className="text-center">
          ...
          {recommendations.length > 0 && (
            <p className="text-gray-600">
              Based on your profile, here are your customized nutrition recommendations
            </p>
          )}
        </div>
